...
<form method="post" action="options.php" id="myForm">
  ...
  <div class="alert alert-danger mt-3 mx-3" role="alert">
    <h1 class="boba_alert_title">Active Subscription Form</h1>
    <p class="boba_alert_description">Your subscription forms are not active. You need a Bobachat account to active.
  ...
  ?>
    <div class="boba-header my-3 mt-4" style="display: flex; flex-direction: row;">
      ...
      <button type="button" id="bobachatChange" class="btn btn-outline-primary ml-3"
        value=<?php echo 'https://admin.bobachat.app/integrations' ?>>Change</button>
    </div>
    <div class="d-flex">
    ...
    <div class="row row-wrap">
      ...
      <div class="col-md-3 col-lg-3 col-sm mt-3">
        <div class="card mt-0 p-0">
          ...
          <div class="card-body">
            <p>Mail: <?php echo $integration -> userEmail?></p>
          </div>
        </div>
      </div>
    </div>
